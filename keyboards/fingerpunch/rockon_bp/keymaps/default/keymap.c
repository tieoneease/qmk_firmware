...
[_QWERTY] = LAYOUT_rockon_bp(
    KC_ESC,    KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      KC_LPRN,                            KC_RPRN,   KC_6,      KC_7,      KC_8,      KC_9,      KC_0,      KC_GRV,
    KC_TAB,    KC_Q,      KC_W,      KC_E,      KC_R,      KC_T,      KC_BTN2,                            KC_PGUP,   KC_Y,      KC_U,      KC_I,      KC_O,      KC_P,      KC_BSPC,
    KC_LCTL,   KC_A,      KC_S,      KC_D,      KC_F,      KC_G,      KC_BTN1,                            KC_PGDN,   KC_H,      KC_J,      KC_K,      KC_L,      KC_SCLN,   KC_QUOT,
    KC_LSFT,   KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      ADJUST,                             ADJUST,    KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,   KC_ENT,
                          KC_DOWN,   KC_UP,   KC_LALT,   KC_LGUI,   KC_LALT,     LOWER,   KC_SPC,       RAISE,     KC_SPC,    KC_DOWN,     KC_LEFT,   KC_RIGHT
),
...
[_LOWER] = LAYOUT_rockon_bp(
    ...
    _______,       _______,       _______,       _______,       _______,       _______,       _______,                              _______,       _______,       KC_LBRC,       KC_RBRC,       KC_BSLS,        KC_GRV,       _______,
    _______,       _______,       _______,       _______,       _______,       _______,       _______,                              _______,       _______,       KC_LPRN,       KC_RPRN,       _______,       _______,       _______,
                                  _______,       _______,       _______,       _______,       _______,    _______,       _______,   _______,       _______,       _______,       KC_DOWN,       KC_UP
),

[_RAISE] = LAYOUT_rockon_bp(
    _______,       _______,       _______,       _______,       _______,       _______,       _______,                              _______,       _______,       _______,       _______,       _______,       _______,        _______,
    _______,       _______,       _______,       _______,       _______,       _______,       _______,                              _______,       _______,       _______,       _______,       _______,       _______,       _______,
    _______,       KC_VOLD,       KC_VOLU,       _______,       _______,       _______,       _______,                              _______,       _______,       RCS(KC_TAB),  LCTL(KC_TAB),   _______,       _______,       _______,
    _______,       _______,       _______,       _______,       _______,       _______,       _______,                              _______,       _______,       _______,       _______,       _______,       _______,       _______,
